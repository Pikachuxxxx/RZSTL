...
namespace Razix {
    namespace rzstl {
        ...
        namespace Internal {    // Same logic as EASTL for internal implementations
            ...
            template<typename Element, rzstl::size_t N>
            class constexpr_map
            {
            private:
            ...
            public:
                ...
                using size_type       = rzstl::size_t;
                using difference_type = rzstl::ptrdiff_t;
                ...
                constexpr rzstl::size_t count(const key_type& key) const noexcept
                {
        ...
        template<typename Key, typename Value, rzstl::size_t N>
